...
export function RecentSubmissions() {
  ...
  return <section className={styles.recentSubmissions} aria-label="Latest three submissions">
    ...
    <p className={styles.recentCaption}>Latest 3 · Recorded application status</p>
    ...
    <p className={styles.recentCaption}>Employer responses are tracked separately in Inbox and Pipeline.</p>
  </section>;
}
