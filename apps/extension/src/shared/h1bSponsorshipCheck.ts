...
const UNLIKELY_PATTERNS: Array<{ pattern: RegExp; signal: string }> = [
  ...
  { pattern: /\bunable to (?:offer |provide )?sponsor\b/i, signal: 'Unable to sponsor' },
  ...
  { pattern: /\bcan'?t (?:offer|provide|sponsor) (?:visa )?sponsorship\b/i, signal: 'Cannot offer sponsorship' },
  { pattern: /\bcannot (?:offer|provide|sponsor) (?:visa )?sponsorship\b/i, signal: 'Cannot offer sponsorship' },
  { pattern: /\bcan'?t offer\b/i, signal: 'Cannot offer sponsorship' },
  { pattern: /\bcannot offer\b/i, signal: 'Cannot offer sponsorship' },
  { pattern: /\bcan'?t sponsor\b/i, signal: 'Cannot sponsor' },
  { pattern: /\bcannot sponsor\b/i, signal: 'Cannot sponsor' },
  { pattern: /\bnot offer (?:visa )?sponsorship\b/i, signal: 'Will not offer sponsorship' },
  { pattern: /\bunable to offer (?:visa )?sponsorship\b/i, signal: 'Unable to offer sponsorship' },
  { pattern: /\bnot offering (?:visa )?sponsorship\b/i, signal: 'Not offering sponsorship' },
